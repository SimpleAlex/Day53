...
Particle.prototype.render = function() {
  ...
  ctx.shadowColor = 'hsla(136, 54%, 33%, ' + Math.max( 0, Math.min( 1, this.alpha ) ) * 2 + ')';
  ctx.fillStyle = 'hsla(136, 54%, 33%, ' + Math.max( 0, Math.min( 1, this.alpha ) ) + ')';
  ctx.fill();
};
